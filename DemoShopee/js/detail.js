...
const SetConfirmModal =() =>{
    ...
    buttonConfirm.addEventListener("click",()=>{
        ...
        fetch(
            `https://localhost:7186/api/Customer/1`
        )
        .then((response) => response.json())
        .then((data) =>{
        ...
        confirmButton.addEventListener("click",()=>{
            ...
            fetch("https://localhost:7186/api/Order",{
                ...
                body:(JSON.stringify({
                    ...
                    timeOrder:"2022-08-09T07:52:28.619Z",
            ...
            itemPurchased.forEach((item)=>{
                const itemPurchasedInfo=document.querySelector("div")
                console.log(item.value5,item.value2,item.value4);
